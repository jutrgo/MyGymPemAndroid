...
import proyecto.pem.mygym.ejercicios.view.AdapterEjercicios;

public class AdapterCategory extends RecyclerView.Adapter<AdapterCategory.FilaViewHolder> {

    private String[] items;
    private SeleccionListener oyente;

    public AdapterCategory(Object[] datos, SeleccionListener oyente) {
        items = (String[]) datos;
        this.oyente = oyente;
    }
        ...
        public FilaViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    oyente.onClick(AdapterCategory.FilaViewHolder.this, getAdapterPosition());
                }
            });
        }
    }
